...
export const table = "/table.png";
export const cat = "/cat.gif";
export const creeper = "/creeper_painting.png";
export const hollow = "/hollow_painting.png";
export const blank = "/blank_painting.png";