...
export var movements = [
    ...
    { id: 3, x: 0.45, y: 0, start_anm: animations.walking, final_anm: animations.changing, duration: 3, delay: 0, scaleX: 1, action: "nextSlide", action_time: 1200 },
    { id: 4, x: 0.45, y: 0, start_anm: animations.talking, final_anm: animations.talking, duration: 3, delay: 0, scaleX: 1, text: "assim fico melhor"},
]