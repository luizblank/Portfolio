...
export default function Animation() {
	...
	return (
		<>
			{
				windowDimensions.width > windowDimensions.height && (windowDimensions.width >= 1024 || !windowDimensions.height >= 768) ?
					...
					<div className={styles.repositories}>
						...
						<div className={styles.warning}>
							the project's animation is not available for resolutions where the width is lower than the height
						</div>
					</div>
			}
		</>
